...
useEffect(() => {
  API.get("/services")
    .then((res) => {
      console.log("SERVICES DATA:", res.data);  // 👈 ADD THIS
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-black text-white p-6">
      ...
      <Motion.h1
        ...
        className="text-4xl font-bold text-center mt-4 mb-6"
      >
        📑 LuxDrive's Exceptional Service Catalog 📑
      </Motion.h1>
      ...
      >
        Premium automobile services crafted for luxury vehicles
      </Motion.p>
    ...
    <div className="flex items-start gap-6">
      ...
      <div>
        ...
        <div className="space-y-4 text-gray-300 leading-relaxed text-[15px] md:text-base">
          ...
          <p className="italic">
            Every vehicle demands a tailored approach.
          </p>

          <p className="text-gray-400">
            Pricing reflects configuration, performance specification, and technical complexity.
          </p>

          <p className="text-gray-500">
            Final estimates follow detailed inspection. Transparent. Accurate. Professional.
          </p>
    ...
    {categoryOrder
      ...
      .map((category) => {
        ...
        return (
          ...
          >
            {/* CATEGORY HEADER */}
            <h2 className="text-3xl font-bold mb-8 border-b border-white/10 pb-4 text-yellow-400">
              {category}
            </h2>
